    ...
    <div class="d-flex toggled" id="wrapper">
      ...
      <div id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush b_right">
          ...
          <div class="row centro color3 b_bottom2 logohome" style="width: 106%; padding-top: 14%; padding-bottom: 5%; height: 200px">
...
?>
            <div class="container div color2">
              ...
              <form action="../controllers/perfil.php" method="POST" name="form3">
