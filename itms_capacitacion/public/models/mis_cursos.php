			...
			<?php  
				...
				echo "<div class='row centro'>";
					...
					if ($pagina_actual != 1) {
						...
						echo "<li><a class='btn btn-sm page-link flecha' href='?pagina=".($pagina_actual-1)."'>";
					...
					for ($i=1; $i <= $total_paginas; $i++) { 
						if($pagina_actual == $i){
							echo "<li><a class='btn btn-sm page-link pagina active' href='?pagina=".$i."'>".$i."</a>";
						}else{
							echo "<li><a class='btn btn-sm page-link pagina' href='?pagina=".$i."'>".$i."</a>";
						}
					}
